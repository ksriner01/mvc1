...
namespace ContosoUniversity.Migrations
{
    ...
    {
        //kriner-mvc9
        //Changed the Up method of the Inheritance migration to remove foreign key constraints and indexes, renames the Instructor table as Person,
        //adds nullable EnrollmentDate for students, adds Discriminator column to tell if a person is an Instructor or Student, copies
        //data from the Student table to the Person table, and re-creates foreign key constraints to point to the Person table.
